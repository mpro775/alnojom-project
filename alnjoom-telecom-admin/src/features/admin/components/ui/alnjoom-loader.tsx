...
type AlnjoomLoaderSize = 'sm' | 'md' | 'lg';

interface AlnjoomLoaderProps {
  size?: AlnjoomLoaderSize;
  label?: string;
...
const SIZE_MAP: Record<AlnjoomLoaderSize, { mark: number; dot: number; font: string }> = {
  sm: { mark: 34, dot: 5, font: '0.78rem' },
  md: { mark: 48, dot: 7, font: '0.86rem' },
  lg: { mark: 64, dot: 9, font: '0.94rem' },
};

export function AlnjoomLoader({
  size = 'md',
  label = 'جاري التحميل...',
  tone = 'primary',
  compact = false,
      ...
      >
        <Box
          sx={{
            ...
            animation: 'alnjoom-loader-float 1.8s ease-in-out infinite',
          }}
        />
        <Box
          sx={{
            ...
            animation: 'alnjoom-loader-pulse 1.8s ease-in-out infinite',
          }}
        />
        {[0, 1, 2].map((index) => (
          <Box
            ...
            sx={{
              ...
              animation: 'alnjoom-loader-trail 1.35s ease-in-out infinite',
